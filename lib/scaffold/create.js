...
var BASE_PACKAGE = {
  description: 'A full aipg node build with aipgcore',
 ...
 * @param {String} options.datadir - The aipg database directory
 ...
 * aipg configuration, and will install all necessary dependencies.
 *
 * @param {Object} options
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The name of the aipgcore node configuration directory
 * @param {String} options.datadir - The path to the aipg datadir
...
function create(options, done) {
  ...
  async.series([
    ...
    function(next) {
      // Setup the aipg directory and configuration
      if (!fs.existsSync(absDataDir)) {
        createaipgDirectory(absDataDir, next);
      } else {
        next();
      }
    },
