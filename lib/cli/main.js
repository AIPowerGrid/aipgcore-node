...
var aipgcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = aipgcorenode.version;
  var create = aipgcorenode.scaffold.create;
  var add = aipgcorenode.scaffold.add;
  var start = aipgcorenode.scaffold.start;
  var remove = aipgcorenode.scaffold.remove;
  var callMethod = aipgcorenode.scaffold.callMethod;
  var findConfig = aipgcorenode.scaffold.findConfig;
  var defaultConfig = aipgcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the aipgcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `aipgcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ aipgcore-node add wallet-service');
      console.log('    $ aipgcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ aipgcore-node remove wallet-service');
      console.log('    $ aipgcore-node remove insight-api');
      console.log();
    });
