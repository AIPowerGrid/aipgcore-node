...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.aipg', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/aipgcore-node.json';
      ...
      config.services.should.deep.equal(['aipgd', 'web']);
      config.servicesConfig.aipgd.spawn.datadir.should.equal('./data');
